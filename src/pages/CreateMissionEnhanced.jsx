            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    <optgroup label="🆓 Groq (Best Free - 30 req/min)" className="bg-gray-900">
                      <option value="llama-3.1-70b-versatile" className="bg-gray-900">🚀 Llama 3.1 70B (Recommended)</option>
                      ...
                      <option value="qwen-2.5-72b-instruct" className="bg-gray-900">🎯 Qwen 2.5 72B</option>
                    </optgroup>
                    ...
                    <optgroup label="💰 Google Gemini (Cheap)" className="bg-gray-900">
                      <option value="gemini-1.5-flash" className="bg-gray-900">Gemini 1.5 Flash ($0.0006/gen)</option>
                  ...
                  <p className="text-xs text-purple-300 mt-1">
                    💡 Auto-fallback enabled: If rate limited, will automatically try Gemini
                  </p>
                </div>
              </div>
