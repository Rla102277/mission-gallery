...
function registerRoutes() {
  app.post("/api/images/upload", isAuthenticated, requireAdmin, upload.single("file"), async (req, res) => {
  ...
  app.delete("/api/images/:id", isAuthenticated, requireAdmin, async (req, res) => {
    if (!CF_ACCOUNT_ID || !CF_IMAGES_TOKEN) {
  ...
  app.get("/api/images/list", isAuthenticated, requireAdmin, async (req, res) => {
    if (!CF_ACCOUNT_ID || !CF_IMAGES_TOKEN) {
